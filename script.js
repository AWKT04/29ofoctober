const barroGif = document.getElementById('barro-gif');
let lastScrollY = 0;
...
window.addEventListener('scroll', () => {
    ...
    // ===== BARRO GIF AL HACER SCROLL =====
    const barroGif = document.getElementById('barro-gif');
    let scrollTimeout;
    
    window.addEventListener('scroll', () => {
      // Mostrar al hacer scroll
barroGif.style.opacity = '1';
    
      // Ocultarlo cuando el usuario deja de hacer scroll
clearTimeout(scrollTimeout);
scrollTimeout = setTimeout(() => {
        barroGif.style.opacity = '0';
}, 200);
    });
});
